...
const jieba = require("./load-jieba"); // 使用辅助模块加载
...
async function searchPosts(query) {
  ...
  if (!safeQuery) {
    console.log("Safe Query 为空，返回空结果");
    return [];
  }
